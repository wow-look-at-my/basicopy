...
func TestValidate(t *testing.T) {
	cases := []struct {
		...
		{"contents needs target-dir", func(o *Options) { o.TargetDir = ""; o.TargetFile = "f"; o.Contents = true }, false},
		{"contents with target-dir ok", func(o *Options) { o.Contents = true }, true},
		{"mirror contents multi-source", func(o *Options) { o.Contents = true; o.Mirror = true; o.Sources = []string{"a", "b"} }, false},
		{"mirror contents single source ok", func(o *Options) { o.Contents = true; o.Mirror = true }, true},
